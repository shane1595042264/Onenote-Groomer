...
void main() async {
  ...
  const existingFile = r'C:\Users\douvle\Documents\Project\onenote_to_excel\June 2025_extracted.xlsx';
  ...
  try {
    ...
    if (template != null) {
      ...
      // Write cleaned data
      const outputPath = r'C:\Users\douvle\Documents\Project\onenote_to_excel\cleaned_sample_output.xlsx';
